...
class Zix_Navwalker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if (is_a( $content, 'WP_Post' ) && has_shortcode( $content->post_content, 'heading_menu_list')) {
        ...
        $item_output .= ( $args->has_children && 1 === $depth || $args->has_children && 0 === $depth) ? '</a>' : esc_attr( $item->attr_title ) . '&nbsp;</a>';
