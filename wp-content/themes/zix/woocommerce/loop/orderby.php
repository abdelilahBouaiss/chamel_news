...
<div class="col-lg-6 col-sm-7">
    <div class="shop_menu_right d-flex justify-content-end">
        <?php if($permalink != '/%plain%/' ) : ?>
            <div class="view-style d-flex <?php echo esc_attr($layout) ?>">
        ...
        <form class="woocommerce-ordering zix_select" method="get">
