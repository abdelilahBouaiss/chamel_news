...
<head>
  ...
  <!-- Favicons
  ================================================== -->
  <link rel="shortcut icon" href="<?php if(isset($theme_option['favicon']['url'])){ echo esc_url($theme_option['favicon']['url']);}  ?>" type="image/png">
  <link rel="apple-touch-icon" href="<?php if(isset($theme_option['apple_icon']['url'])){ echo esc_url($theme_option['apple_icon']['url']);}  ?>">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php if(isset($theme_option['apple_icon_72']['url'])){ echo esc_url($theme_option['apple_icon_72']['url']);}  ?>">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php if(isset($theme_option['apple_icon_114']['url'])){ echo esc_url($theme_option['apple_icon_114']['url']);}  ?>">
    <link rel="apple-touch-icon" sizes="57x57" href="<?php if(isset($theme_option['apple_icon_144']['url'])){ echo esc_url($theme_option['apple_icon_144']['url']);}  ?>">
...
<?php
if(get_post_meta($wp_query->get_queried_object_id(), "_cmb_disable_preloader", true)!='on' && $theme_option['theme_preloader']){
?>
...
<div class="color-switcher" id="choose_color"> <a href="#." class="picker_close"><i class="fa fa-gear fa-spin" ></i></a>
  <div class="theme-colours">
    <p><?php esc_html_e('Settings', 'driveme') ?></p>
    <ul>
  ...
  <header class="sticky">
    <div class="container">
      <nav class="navbar navbar-default">
		...
		<?php 
		if($theme_option["hide_menu_cart"]!=1){?>	
        <ul class="nav navbar-nav pull-right">
            <?php 
            if(function_exists('is_woocommerce')){
             echo driveme_woocommerce_cart_dropdown();
           } ?>
         </ul>
         <?php }?>
          <?php
