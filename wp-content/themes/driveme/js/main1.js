...
$(document).ready(function ($) {
    ...
    $('.text-slider .get-form').on( 'click', function (event) {
        event.preventDefault();       
...
$(function () {
    if ($("#contact_form").length) {
        ...
        $("#contact_form #btn_submit").on( 'click', function () {
...
$(function () {
    if ($("#find_course").length) {
        ...
        $("#find_course #btn_submit").on( 'click', function () {
            // validate and process form
            // first hide any error messages
...
$(function () {
    if ($("#user_billing").length) {
        ...
        $("#offline_payment").on( 'click', function () {
            // validate and process form
            // first hide any error messages
            //$('#find_course .error').hide();
