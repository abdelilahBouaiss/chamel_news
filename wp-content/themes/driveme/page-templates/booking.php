...
$current_course = (int) (array_key_exists('booking_title', $_POST) ? $_POST['booking_title'] : (array_key_exists('cid', $_GET) ? $_GET['cid'] : 0));
		...
		<div class="container">
			...
			<section class="products billing-info">
				...
				<div class="row">
					<div class="col-md-9">
						<div id="payment-wrap">
							...
							<div class="payment-overlay">
								<h3><span></span><?php echo __('Loading...', 'driveme'); ?></h3>
							</div>
								...
								<ul class="row">
									...
									<li class="col-sm-6">
										<div class="form-group">
											...
											<input type="text" data-toggle="tooltip" placeholder="<?php echo __('Name', 'driveme'); ?>" name="firstname" required class="form-control" id="ub_name" data-bind="in:value" value="<?php echo ( isset($_SESSION['driveme']['sl_name'] ) ) ? esc_attr( $_SESSION['driveme']['sl_name'] ) : '' ;?>">
									...
									<li class="col-sm-6">
										<div class="form-group">
											<div class="field-error"></div>
											<input type="email" data-toggle="tooltip" placeholder="<?php echo __('Email', 'driveme'); ?>" name="lastname" required class="form-control" id="ub_name_surname" data-bind="in:value">
											<span class="fa fa-user"></span>
										</div>
									</li>
									...
									<li class="col-sm-6">
										<div class="form-group">
											<div class="field-error"></div>
											<input type="text" data-toggle="tooltip" placeholder="<?php echo __('Your Phone', 'driveme'); ?>" name="phone" required class="form-control" id="ub_phone" data-bind="in:value" value="<?php echo ( isset($_SESSION['driveme']['sl_phone'] ) ) ? esc_attr( $_SESSION['driveme']['sl_phone'] ) : '' ;?>">
									...
									<li class="col-sm-6">
										<div class="form-group">
											<div class="field-error"></div>
											<input type="email" data-toggle="tooltip" placeholder="<?php echo __('Your Mail Address', 'driveme'); ?>" name="email" class="form-control" id="ub_email" data-bind="in:value" value="<?php echo ( isset($_SESSION['driveme']['sl_email'] ) ) ? esc_attr( $_SESSION['driveme']['sl_email'] ) : '' ;?>">
									...
									<li class="col-md-6">
										<div class="form-group">
											<div class="field-error"></div>
											<select data-toggle="tooltip" placeholder="<?php echo __('Course', 'driveme'); ?>" name="course" required id="ub_course_name" class="form-control stylee" type="text" data-bind="in:value">
												...
												?>
													<option value="<?php echo esc_html($course->ID); ?>:<?php echo esc_html($price_num); ?>:<?php echo htmlspecialchars(str_replace(':', ' ', $course->post_title)); ?>" <?php if ($current_course == $course->ID) echo ' selected'; ?>><?php echo htmlspecialchars($course->post_title) . ' [' . $price . ']'; ?></option>
												<?php } ?>
											</select>
									...
									<li class="col-md-6">
										<div class="form-group">
											<div class="field-error"></div>
											<input type="text" placeholder="DD/MM/YY" id="datepicker" class="form-control hasDatepicker" name="date" data-bind="in:value" value="<?php echo ( isset($_SESSION['driveme']['courses-date'] ) ) ? esc_attr( $_SESSION['driveme']['courses-date'] ) : '' ;?>">
									...
									<li class="col-sm-12">
										<div class="form-group">
											<div class="field-error"></div>
											<textarea placeholder="<?php echo __('Your additional Message', 'driveme'); ?>" name="message" id="ub_message" cols="" rows="5" data-bind="in:value"></textarea>
									...
									<ul role="tablist" class="nav nav-tabs">
										<?php if ($processors['stripe']) { ?>
											<li<?php if ($active == 'stripe') echo ' class="active"' ?>role="presentation">
												<a data-toggle="tab" role="tab" aria-controls="credit" href="#credit" aria-expanded="false"><?php echo __('Credit Card', 'driveme'); ?> </a>
												</li>
											<?php } ?>
											<?php if ($processors['paypal']) { ?>
												<li<?php if ($active == 'paypal') echo ' class="active"' ?> role="presentation">
													<a data-toggle="tab" role="tab" aria-controls="paypal" href="#paypal" aria-expanded="false"><?php echo __('PayPal', 'driveme'); ?></a></li>
												<?php } ?>
												<?php if ($processors['offline']) { ?>
													<li<?php if ($active == 'offline') echo ' class="active"' ?> role="presentation">
														<a data-toggle="tab" role="tab" aria-controls="offline" href="#offline" aria-expanded="false"><?php echo __('Offline', 'driveme'); ?></a>
														</li>
													<?php } ?>
									</ul>
								</div>
											...
											<div class="intres-lesson">
												...
												<form class="stripe-form" method="post" action="<?php the_guid(); ?>" data-form-type="stripe">
													...
													<ul class="row">
														...
														<li class="col-sm-12">
															<div class="form-group">
																<input type="text" placeholder="<?php _e('Card Number', 'driveme'); ?>" required autocomplete="off" <?php if ($theme_option['payment_cc_testmode']) { ?>value="4242424242424242" <?php } ?> class="form-control stripe-number">
														...
														<li class="col-sm-6">
															<div class="form-group">
																<input type="text" placeholder="<?php _e('CVC Number', 'driveme'); ?>" required autocomplete="off" <?php if ($theme_option['payment_cc_testmode']) { ?>value="111" <?php } ?> class="form-control stripe-cvc">
																<span class="fa fa-credit-card"></span>
															</div>
														</li>
														...
														<li class="col-sm-6">
															<div class="row date-info">
																...
																<div class="col-xs-4">
																	<div class="form-group">
																		<select class="form-control stripe-expiry-month" autocomplete="off" required type="text">
																...
																<div class="col-xs-4">
																	<div class="form-group">
																		<select class="form-control stripe-expiry-year" autocomplete="off" required type="text">
																			<option><?php echo __('Year', 'driveme'); ?></option>
																			<?php $year = date('Y');
																			for ($ii = 0; $ii <= 7; $ii++) { ?>
																				<option value="<?php echo esc_html($year + $ii); ?>" <?php if ($ii == 1 && $theme_option['payment_cc_testmode']) echo ' selected="selected"'; ?>><?php echo esc_html($year + $ii); ?></option>
																			<?php } ?>
																		</select>
																	</div>
																</div>
					...
					$numbers = isset($_POST['booking_title']) ? esc_attr($_POST['booking_title']) : '';
					...
					?>
						...
						<div class="col-md-3">
							...
							<div class="prodct">
								...
								<div class="pro-info">
									...
									<p><i class="fa fa-exclamation-circle"></i>
										...
										<?php if (isset($theme_option['courses_excerpt']) && $theme_option['courses_excerpt'] != '') {
											echo driveme_excerpt($theme_option['courses_excerpt']);
										} else {
											echo driveme_excerpt(15);
										} ?></p>

									<p> <strong>Total Price: <?php echo esc_attr($prices); ?></strong></p>

									<a href="<?php echo esc_url($theme_option['booking_sidebarlink']); ?>" class="btn">Update course</a>
								</div>
							...
							<div class="where">
								...
								<a href="<?php echo esc_url($theme_option['booking_sidebarlink']); ?>"><i class="fa fa-calendar"></i> <?php echo esc_html_e('Add to My Calendar', 'driveme'); ?></a>
							</div>
							...
							<div class="where">
								...
								<a href="<?php echo esc_url($theme_option['booking_sidebarlink_sent_msg']); ?>"><i class="fa fa-envelope"></i> <?php echo esc_html_e('Send a Message', 'driveme'); ?></a>
							</div>
