...
class LeadinAdmin {
	...
	public function build_menu() {
		if ( Connection::is_connected() ) {
				...
				add_submenu_page( MenuConstants::ROOT, __( 'Lists', 'leadin' ), __( 'Lists', 'leadin' ), Filters::apply_view_plugin_menu_capability_filters(), MenuConstants::LISTS, array( $this, 'build_app' ) );
